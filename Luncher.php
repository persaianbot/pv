...
define('BOT_TOKEN', '182607202:AAFKk5gUGmNxsWwxKEKAdP4mzTgfPEzL3cE');
...
";
      ...
      apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "<b>Private Creator</b>
<b>ver. 1.0</b>
<code>Coded By</code> @MosyDev
...
🗣پیام ارسال شد");
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[1].'/setwebhook?url=https://mosydev.gigfa.com/Luncher.php'.$chat_id.'/pvresan.php');
...
";
     ...
     mkdir($id, 0700);
        ...
        $phptext = str_replace("**ADMIN**",$chat_id,$phptext);
        file_put_contents($token.$id.'/phptext.txt',$phptext);
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=');
        file_get_contents('https://api.telegram.org/bot'.$text.'/setwebhook?url=https://mosydev.gigfa.com/Luncher.php'.$chat_id.'/phptext.txt');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
به ربات ما امتیاز بدید  👇
 https://telegram.me/storebot?start=PrivateCreatorBot
.";
    
    $bot_url    = "https://api.telegram.org/bot182607202:AAFKk5gUGmNxsWwxKEKAdP4mzTgfPEzL3cE/"; 
...
";
     ...
     mkdir($id, 0700);
        ...
        file_get_contents('https://api.telegram.org/bot'.$matches[0].'/setwebhook?url=https://mosydev.gigfa.com/Luncher.php'.$id.'/pvresan.php');
    $unstalled = "ربات شما با موفقیت نصب شده است🚀 
برای ورود به ربات خود کلیک کنید 👇😃
";
